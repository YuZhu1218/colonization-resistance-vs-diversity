...
for ns = 1:nSample
    ...
    rIntMatAI = [rIntMatA; RpI.*DistInteractionStrengthMT_PB(1,nMediator,ri0I,fpI)];
    rIntMatBI = [rIntMatB; RpI.*DistInteractionStrengthMT_PB(1,nMediator,ri0I,fpI)];
    rIntMatEI = [rIntMatE; RpI.*DistInteractionStrengthMT_PB(1,nMediator,ri0I,fpI)];
    AI = [A'; at*RpI.*(0.5+rand(1,nMediator))]';
...
save(strcat('V3ac_Dp_ExMT4C_ABE_fp',num2str(round(100*fp)),'_fpI',num2str(round(100*fpI)),'_CSD',num2str(nInitialCell,2),'_DilTh',num2str(dilTh,2),'_ExtTh',num2str(extTh),'_Ksat',num2str(kSatLevel),'_ri',num2str(round(100*ri0)),'_riI',num2str(round(100*ri0I)),'_r0m',num2str(round(100*r0m)),'_r0Inv',num2str(round(100*r0Inv)),'_bt',num2str(round(100*bt)),'_at',num2str(round(100*at)),'_Nc',num2str(nCellType),'_Nm',num2str(nMediator),'_qp',num2str(round(100*qp)),'_qc',num2str(round(100*qc)),'_qpi',num2str(round(100*qpi)),'_qci',num2str(round(100*qci)),'_Nr',num2str(nRound),'_Ns',num2str(nSample),'_rndseed',num2str(rndseed0),'.mat'))
